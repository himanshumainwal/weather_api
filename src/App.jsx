...
const WeatherApp = () => {
  ...
  return (
    <div className="flex bg-linear-to-r from-cyan-500 to-blue-500 flex-col items-center justify-center min-h-screen text-white p-5">
      ...
      {weather && (
        <div className="mt-6 p-5 rounded-lg shadow-md w-full max-w-md bg-linear-to-r from-cyan-500 to-blue-500">
      ...
      {forecast.length > 0 && (
        <div className="mt-6 p-6 rounded-lg shadow-md w-full max-w-md bg-linear-to-r from-cyan-500 to-blue-500">
